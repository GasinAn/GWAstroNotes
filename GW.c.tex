...
\begin{equation}
    h=\frac{\mathcal{M}[\pi \mathcal{M}F(t)]^{2/3}}{D_\text{L}}Q(\theta,\phi,\psi,\iota)\cos[\int 2\pi F(t)\,\d t]
\end{equation}
\begin{equation}
    h=\frac{\mathcal{M}[\pi \mathcal{M}F(t)]^{2/3}}{D_\text{L}/c}Q(\theta,\phi,\psi,\iota)\cos[\int 2\pi F(t)\,\d t]
\end{equation}
\begin{equation}
    h=\sqrt{\frac{c^*\mu_\text{G}^*}{c\mu_\text{G}}}\frac{\mathcal{M}[\pi \mathcal{M}F(t)]^{2/3}}{D_\text{L}/c^*}Q(\theta,\phi,\psi,\iota)\cos[\int 2\pi F(t)\,\d t]
\end{equation}
\begin{equation}
    h=\sqrt{\frac{{c^{*3}}\mu_\text{G}^*}{c^3\mu_\text{G}}}\frac{\mathcal{M}[\pi \mathcal{M}F(t)]^{2/3}}{D_\text{L}/c}Q(\theta,\phi,\psi,\iota)\cos[\int 2\pi F(t)\,\d t]
\end{equation}

...
\end{equation}
\begin{equation}
    {A_\text{(E2)}}_i=\frac{\mu_0}{4\pi}\frac{1}{\left\lvert\vec{r}\right\rvert}\frac{\d}{\d t}p_i(t-\frac{\left\lvert\vec{r}\right\rvert}{c})
\end{equation}
\begin{equation}
    {A_\text{(E4)}}_i=\frac{\mu_0}{4\pi}\frac{1}{\left\lvert\vec{r}\right\rvert}n^j\frac{1}{2}\frac{\d^2}{\d t^2}D_{ij}(t-\frac{\left\lvert\vec{r}\right\rvert}{c})
\end{equation}
...
\end{equation}
\begin{equation}
    \vec{E}=-\frac{\p}{\p t}\vec{A}
\end{equation}
\begin{equation}
    \vec{S}=-\frac{1}{\mu_0}(\frac{\p}{\p t}\vec{A})\times(\nabla\times\vec{A})
\end{equation}
\begin{equation}
    S_a=-\frac{c}{\mu_0}\epsilon_{abc}(\p_0A^b)\epsilon^{cde}\p_dA_e
\end{equation}
\begin{equation}
    S_a=-\frac{c}{\mu_0}(\p_0A^b)\epsilon_{cab}\epsilon^{cde}(\p_dA_e)
\end{equation}
\begin{equation}
    S_a=-\frac{4c}{\mu_0}\delta^{[d}_a\delta^{e]}_b(\p_0A^b)(\p_dA_e)
\end{equation}
\begin{equation}
    S_a=-\frac{2c}{\mu_0}(\delta^{d}_a\delta^{e}_b-\delta^{e}_a\delta^{d}_b)(\p_0A^b)(\p_dA_e)
\end{equation}
\begin{equation}
    S_a=-\frac{2c}{\mu_0}[(\p_0A^b)(\p_aA_b)-(\p_0A^b)(\p_bA_a)]
\end{equation}
\begin{equation}
    S\propto\frac{c}{\mu}\frac{\omega}{c}kA^2=\frac{\omega^2A^2}{c\mu}
\end{equation}
\begin{equation}
    F\sim\frac{\left\lvert \dot{h}\right\rvert^2 }{16\pi}\sim\frac{E}{4\pi r^2T}
\end{equation}
\begin{equation}
    F: [E][L]^{-2}[T]^{-1}=[M][T]^{-3}
\end{equation}
\begin{equation}
    \left\lvert \dot{h}\right\rvert^2: [T]^{-2}
\end{equation}
\begin{equation}
    G: [L]^{3}[M]^{-1}[T]^{-2}
\end{equation}
...
\end{equation}
\begin{equation}
    c^3\left\lvert \dot{h}\right\rvert^2: [L]^{3}[T]^{-5}
\end{equation}
\begin{equation}
    F\propto \frac{c^3}{G}\left\lvert \dot{h}\right\rvert^2\propto\frac{c^3\omega^2h^2}{G}\propto\frac{\omega^2h^2}{c\mu_\text{G}}\,(!)
\end{equation}

\subsection{definition}

$\frac{4G}{c^4}:=\frac{\mu_\text{G}}{4\pi}$, $c:=\frac{1}{\sqrt{\epsilon_\text{G}\mu_\text{G}}}$, $G:=\frac{\mu_\text{G}}{16\pi\epsilon_\text{G}^2\mu_\text{G}^2}$

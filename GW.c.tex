...
\begin{equation}
    \hat{A}_{\mu}(\omega,\vec{r})=\frac{\mu_0}{4\pi}\frac{-i\omega e^{i\omega\left\lvert\vec{r}\right\rvert}}{\left\lvert\vec{r}\right\rvert}\int\hat{J}_{\mu}(\omega,\vec{r}')(\frac{\vec{r}}{\left\lvert\vec{r}\right\rvert}\cdot\vec{r}')\,\d V'
\end{equation}
\begin{equation}
    \hat{\bar{h}}_{\mu\nu}(\omega,\vec{r})=4G\frac{-i\omega e^{i\omega\left\lvert\vec{r}\right\rvert}}{\left\lvert\vec{r}\right\rvert}\int\hat{T}_{\mu\nu}(\omega,\vec{r}')(\frac{\vec{r}}{\left\lvert\vec{r}\right\rvert}\cdot\vec{r}')\,\d V'
\end{equation}

\begin{equation}
    \hat{\vec{A}}=\frac{\mu_0}{4\pi}\frac{-i\omega e^{i\omega r}}{r}\int\hat{\vec{J}}'(\vec{n}\cdot\vec{r}')\,\d V'
\end{equation}
\begin{equation}
    \hat{\vec{\vec{\bar{h}}}}=4G\frac{-i\omega e^{i\omega r}}{r}\int\hat{\vec{\vec{T}}}'(\vec{n}\cdot\vec{r}')\,\d V'
\end{equation}

\begin{equation}
    A_{i}=\frac{\mu_0}{4\pi}\frac{1}{\left\lvert\vec{r}\right\rvert}\frac{1}{6}\mathcal{P}_{ijk}\frac{\d^2}{\d t^2}{D}^{jk}(t-\left\lvert\vec{r}\right\rvert)
\end{equation}
\begin{equation}
    h_{ij}=4G\frac{1}{\left\lvert\vec{r}\right\rvert}\frac{1}{6}\mathcal{P}_{ijkl}\frac{\d^2}{\d t^2}{Q}^{kl}(t-\left\lvert\vec{r}\right\rvert)
\end{equation}

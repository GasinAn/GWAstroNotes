...
\cite{Abbott2021,Thrane2019}, For a given beyond-GR parameter $x$, this distribution $p(x|d)$ is the expectation for $x$ after marginalizing over the hyperparameters $\mu$ and $\sigma$,
\begin{equation}

...
\end{equation}
\begin{equation}
    A_\mu=-\frac{1}{4}c_0\bar{h}_{0\mu}
\end{equation}
...
\end{equation}
\begin{equation}
    \vec{a}\cdot\vec{v}=-\vec{j}\cdot\vec{E}
\end{equation}
\begin{equation}
    \vec{S}=-\vec{E}\times\vec{H}=(\vec{\nabla}\varphi)\times(\frac{1}{\mu}\vec{\nabla}\times\vec{A})=\frac{c^3}{16\pi G}(\vec{\nabla}\varphi)\times(\vec{\nabla}\times\vec{A})
\end{equation}
\begin{equation}
    S^{i}=\frac{c^3}{16\pi G}\varepsilon^{i}_{\ph{i}jk}(-\p_jA_0)(\varepsilon_{klm}\p^lA^m)=\frac{c^3}{16\pi G}\varepsilon^{i}_{\ph{i}jk}(\frac{1}{4}\p_i\bar{h}_{00})(-\frac{1}{4}\varepsilon_{klm}\p^l\bar{h}_{0}^{\ph{0}m})
\end{equation}
\begin{equation}
    S^{i}=-\frac{c^3}{256\pi G}\varepsilon^{i}_{\ph{i}jk}(\p_i\bar{h}_{00})(\varepsilon_{klm}\p^l\bar{h}_{0}^{\ph{0}m})
\end{equation}
\begin{equation}
    L|_{r=r_2}=L|_{r=r_1}\frac{c|_{r=r_1}}{c|_{r=r_2}}
\end{equation}
\begin{equation}
    \begin{cases}

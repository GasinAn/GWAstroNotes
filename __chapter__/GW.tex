...
\end{equation}
\begin{equation}
    \p^{j}\p_{j}A_{i}-\p^{0}\p_{0}A_{i}=-\mu J_{i},\quad
    \p^{j}\p_{j}A_{0}-\p^{0}\p_{0}A_{0}=-\mu J_{0},\quad
    \p^{i}A_{i}+\p^{0}A_{0}=0
\end{equation}
\begin{equation}
    B_{i}=\varepsilon_{i}^{\ph{i}jk}\p_{j}A_{k},\quad
    E_{i}=-(\p_{i}A_0+\p_0A_{i})
\end{equation}
\begin{equation}
    \p^{j}\p_{j}A_{i}-\p^{0}\p_{0}A_{i}-\p_{i}(\p^{j}A_{j}+\p^{0}A_{0})=-\mu J_{i}
\end{equation}
\begin{equation}
    \p^{j}\p_{j}A_{0}-\p^{0}\p_{0}A_{0}+\p_{0}(\p^{j}A_{j}+\p^{0}A_{0})=-\mu J_{0}
\end{equation}
\begin{equation}
    \p^{j}\p_{j}A_{i}-\p^{j}\p_{i}A_{j}=-\mu J_{i}+\p^{0}\p_{i}A_{0}+\p^{0}\p_{0}A_{i},\quad
    \p^{j}\p_{j}A_{0}+\p^{j}\p_{0}A_{j}=-\mu J_{0}
\end{equation}
\begin{equation}
    \varepsilon_{i}^{\ph{i}jk}\p_{j}B_{k}=\mu J_{i}+\p^{0}E_{i},\quad
    \p^{i}E_{i}=\mu J_{0}
\end{equation}

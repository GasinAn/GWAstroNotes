...
\begin{equation}
    \vec{\nabla}\times\vec{E}=-\frac{\p}{\p t}(\mu\vec{H})
\end{equation}
\begin{equation}
    \vec{\nabla}\times\vec{H}=+\frac{\p}{\p t}(\varepsilon\vec{E})
\end{equation}
\begin{equation}
...
\end{equation}
\begin{equation}
    \vec{\nabla}^2\vec{E}-\vec{\nabla}(\vec{\nabla}\cdot\vec{E})-\varepsilon\mu\frac{\p^2}{\p t^2}\vec{E}=0
\end{equation}
\begin{equation}
    \vec{\nabla}^2\vec{H}-\vec{\nabla}(\vec{\nabla}\cdot\vec{H})-\varepsilon\mu\frac{\p^2}{\p t^2}\vec{H}=0
\end{equation}
\begin{equation}
    \varepsilon\vec{\nabla}\cdot\vec{E}+\vec{\nabla}\varepsilon\cdot\vec{E}=0
\end{equation}
\begin{equation}
    \mu\vec{\nabla}\cdot\vec{H}+\vec{\nabla}\mu\cdot\vec{H}=0
\end{equation}

\begin{equation}
    \vec{\nabla}^2\vec{H}-\vec{\nabla}(\vec{\nabla}\cdot\vec{H})-\frac{\p^2}{\p (v_\text{p}t)^2}\vec{H}=0
\end{equation}
\begin{equation}
    \mu\vec{\nabla}\cdot\vec{H}+\vec{\nabla}\mu\cdot\vec{H}=0
\end{equation}
...
\end{equation}
\begin{equation}
    \vec{\nabla}^2\vec{H}-\frac{\p^2}{\p (v_\text{p}t)^2}\vec{H}=0
\end{equation}
\begin{equation}
    \vec{\nabla}\cdot\vec{H}=0
\end{equation}
...
\begin{equation}
    4\pi r_1^2(\vec{E}\times\vec{H})|_{t=0,r=r_1}=4\pi r_2^2(\vec{E}\times\vec{H})|_{t=\int_{r_1}^{r_2}\frac{\d r}{v_\text{p}},r=r_1}
\end{equation}
\begin{equation}
    4\pi r_1^2(\vec{S})|_{t=0,r=r_1}=4\pi r_2^2(\vec{S})|_{t=\int_{r_1}^{r_2}\frac{\d r}{v_\text{p}},r=r_1}
\end{equation}
\begin{equation}

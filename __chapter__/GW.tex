...
\begin{equation}
    \varepsilon_{\text{G}0}:=\frac{c_0}{4\pi G_0},\quad
    \mu_{\text{G}0}:=\frac{4\pi G_0}{c_0^3}
\end{equation}
\begin{equation}
    \begin{cases}
...
\begin{equation}
    \varepsilon_{\text{G}}=\frac{c}{4\pi G},\quad
    \mu_{\text{G}}=\frac{4\pi G}{c^3}
\end{equation}
\begin{equation}
    x^\mu=(ct,x,y,z)
\end{equation}
...
\end{equation}
\begin{equation}
    f(r,t)=e^{(p/2)r}[C_+e^{i(+\sqrt{k-(p/2)^2}r-kct)}+C_-e^{i(-\sqrt{k-(p/2)^2}r-kct)}]
\end{equation}
\begin{equation}
    f(r,t)=e^{(p/2)r}[C_+e^{i(+\sqrt{k-(p/2)^2}r-kct)}+C_-e^{i(-\sqrt{k-(p/2)^2}r-kct)}]
\end{equation}
...
\end{equation}
\begin{equation}
    h_2=\sqrt{\frac{c_1^5/G_1}{c_2^5/G_2}}\frac{r_1}{r_2}h_1
\end{equation}
...
\begin{align}
    h_d&=\sqrt{\frac{{c^*}^5/G^*}{c^5/G}}\frac{r}{d}h_r\\
    &=\sqrt{\frac{{c^*}^5/G^*}{c^5/G}}\frac{\mathcal{M}[\pi \mathcal{M}F_r(t)]^{2/3}}{d/c^*}Q(\theta,\phi,\psi,\iota)
\end{align}
所以地球观者测得
\begin{equation}
    h=\sqrt{\frac{{c^*}^5/G^*}{c^5/G}}\frac{\mathcal{M}[\pi \mathcal{M}F_r(t)]^{2/3}}{d/c^*}Q(\theta,\phi,\psi,\iota)\cos[\int 2\pi \frac{F_r(t)}{1+z}\,\d t]
\end{equation}
记$F_\text{obs}(t)=F_r(t)/(1+z)$, $\mathcal{M}_\text{obs}=\mathcal{M}(1+z)$, 光度距离$d_\text{L}=d(1+z)$, 则
\begin{align}
    h&=\sqrt{\frac{{c^*}^5/G^*}{c^5/G}}\frac{\mathcal{M}[\pi \mathcal{M}F_r(t)]^{2/3}}{d(1+z)/c^*}Q(\theta,\phi,\psi,\iota)\cos[\int 2\pi F_\text{obs}(t)\,\d t]\\
...
\begin{equation}
    d_\text{L,G}=d_\text{L}\sqrt{\frac{c^7/G}{{c^*}^7/G^*}}
\end{equation}

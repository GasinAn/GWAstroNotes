...
\begin{equation}
    \p^c\p_c\bar{h}_{ab}=-16\pi\frac{G_0}{c_0^3}T_{ab},\quad\p^a\bar{h}_{ab}=0
\end{equation}
\begin{equation}
...
\begin{equation}
    \varepsilon_{\text{G}}=\frac{c}{16\pi G},\quad
    \mu_{\text{G}}=\frac{16\pi G}{c^3}
\end{equation}
\begin{equation}
    x^\mu=(ct,x,y,z)
\end{equation}
...
\end{equation}
\begin{equation}
    f(r)=e^{\int(p/2)\,\d r}[C_+e^{i\int\sqrt{k-(p/2)^2}\,\d r}+C_-e^{-i\int\sqrt{k-(p/2)^2}\,\d r}]
\end{equation}
\begin{equation}
    \begin{cases}
...
\begin{equation}
    \begin{cases}
        (\bar{h}_{00})_2=\sqrt{\frac{{\mu_{\text{G}}}_2}{{\mu_{\text{G}}}_1}}\frac{c_1^2}{c_2^2}\frac{r_1}{r_2}(\bar{h}_{00})_1\\
        (\bar{h}_{0i})_2=\sqrt{\frac{{\mu_{\text{G}}}_2}{{\mu_{\text{G}}}_1}}\frac{c_1^2}{c_2^2}\frac{r_1}{r_2}(\bar{h}_{0i})_1
    \end{cases}
\end{equation}
\begin{equation}
    h_2=\sqrt{\frac{c_1^7/G_1}{c_2^7/G_2}}\frac{r_1}{r_2}h_1
\end{equation}
...
\begin{align}
    h_d&=\sqrt{\frac{{c^*}^7/G^*}{c^7/G}}\frac{r}{d}h_r\\
    &=\sqrt{\frac{{c^*}^7/G^*}{c^7/G}}\frac{\mathcal{M}[\pi \mathcal{M}F_r(t)]^{2/3}}{d/c^*}Q(\theta,\phi,\psi,\iota)
\end{align}
所以地球观者测得
\begin{equation}
    h=\sqrt{\frac{{c^*}^7/G^*}{c^7/G}}\frac{\mathcal{M}[\pi \mathcal{M}F_r(t)]^{2/3}}{d/c^*}Q(\theta,\phi,\psi,\iota)\cos[\int 2\pi \frac{F_r(t)}{1+z}\,\d t]
\end{equation}
记$F_\text{obs}(t)=F_r(t)/(1+z)$, $\mathcal{M}_\text{obs}=\mathcal{M}(1+z)$, 光度距离$d_\text{L}=d(1+z)$, 则
\begin{align}
    h&=\sqrt{\frac{{c^*}^7/G^*}{c^7/G}}\frac{\mathcal{M}[\pi \mathcal{M}F_r(t)]^{2/3}}{d(1+z)/c^*}Q(\theta,\phi,\psi,\iota)\cos[\int 2\pi F_\text{obs}(t)\,\d t]\\
    &=\sqrt{\frac{{c^*}^7/G^*}{c^7/G}}\frac{\mathcal{M}_\text{obs}[\pi \mathcal{M}_\text{obs}F_\text{obs}(t)]^{2/3}}{d_\text{L}/c^*}Q(\theta,\phi,\psi,\iota)\cos[\int 2\pi F_\text{obs}(t)\,\d t]\\
    &=\sqrt{\frac{{c^*}^9/G^*}{c^9/G}}\frac{\mathcal{M}_\text{obs}[\pi \mathcal{M}_\text{obs}F_\text{obs}(t)]^{2/3}}{d_\text{L}/c}Q(\theta,\phi,\psi,\iota)\cos[\int 2\pi F_\text{obs}(t)\,\d t]
\end{align}
用引力波测距测得$d_\text{L,G}$, 则
\begin{equation}
    d_\text{L,G}=d_\text{L}\sqrt{\frac{c^9/G}{{c^*}^9/G^*}}
\end{equation}
